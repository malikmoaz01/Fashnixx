...
const ShippingManagement = () => {
  ...
  const cards = [
    { name: "Shipping Settings", id: "Manage shipping options" },
    { name: "Shipping Status", id: "Track and manage shipments" },
    { name: "Shipping History", id: "View past shipping records" },
  ];
