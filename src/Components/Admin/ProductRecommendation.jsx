...
const ProductRecommendation = () => {
  ...
  const cards = [
    { name: "AI-Powered Insights", id: "Recommendations based on customer preferences and purchase history." },
    { name: "Trending Products", id: "Highlight the most popular items across categories." },
    { name: "Seasonal Picks", id: "Promote products that align with current trends or seasons." },
  ];
